...
class PerseestConfig {
   ...
   * @param {Iterable<String|Array>} opt.columns - Additional columns
  ...
  constructor (table, primaryKey, { columns = [] } = {}) {
    ...
    if (!this.columns.has(primaryKey))
      this.columns.set(primaryKey, { id: true })
